...
namespace Day_05_2019_Tests
{
    public class IncodeTests
    {
        ...
        public void TestInitialCodes(string inputState, string expectedResult)
        {
            // Arrange
        ...
        [Theory]
        [InlineData("1002,4,3,4,33", 12, 0)]
        public void TestInitialCodes_Day05_LongInstruction(string inputState, int inputValue, int expectedResult)
        {
            // Arrange
            var input = new Queue<int>();
            input.Enqueue(inputValue);
        ...
        public void TestInitialCodes_Day05_EqualToEight(string inputState, int inputValue, int expectedResult)
        {
            // Arrange
            var input = new Queue<int>();
            input.Enqueue(inputValue);
        ...
        public void TestInitialCodes_Day05_LessThanEight(string inputState, int inputValue, int expectedResult)
        {
            // Arrange
            var input = new Queue<int>();
            input.Enqueue(inputValue);
        ...
        public void TestInitialCodes_Day05_JumpTests(string inputState, int inputValue, int expectedResult)
        {
            // Arrange
            var input = new Queue<int>();
            input.Enqueue(inputValue);
