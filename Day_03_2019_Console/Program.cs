...
namespace Day_03_2019_Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var shortestDistance = calculator.CalculateShortestFromOrigin(interSections);
            ...
            Console.WriteLine("Steps: " + leastSteps);
